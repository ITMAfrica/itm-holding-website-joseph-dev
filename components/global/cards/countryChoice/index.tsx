...
export default function CardCountryChoice(props: any) {
    ...
    >
        <div className="w-full h-full shadow-2xl absolute bottom-0 z-10 right-0 p-4">
            <h3 className={`group-hover:font-bold w-1/2 group-hover:text-blue_itm_aqua_marine ${props.code == CURRENT_CODE ? "text-blue_itm_aqua_marine font-bold" : "font-medium "}`}>
                {props[lang]}
            </h3>
