...
export default function TestimonyItem({ item, index, activeSlide, setActiveSlide }: any) {
  if (activeSlide == index) return <article onClick={function () {
    setActiveSlide(index)
  }} className="w-fit ease-linear h-fit relative z-10 scale-125 pt-[48px] flex items-center justify-center mx-3 my-24">
  ...
  return (
    <article onClick={function () {
      setActiveSlide(index)
    }} className="w-fit h-[467.5px] scale-95 ease-linear flex items-center justify-center pt-[12px] my-24 mx-5">
