export default function HomeCallToAction({ params }: { params: any }) {
  return (
    <section className="py-16 flex justify-center rounded-md overflow-hidden">
      <div className="w-11/12 h-[280px] flex flex-wrap items-center justify-center bg-cover rounded-3xl overflow-hidden bg-no-repeat bg-[url('../public/bg.png')] bg-black/40">
        <div className="w-full text-white">
          ...
          <p className="text-center pt-2 pb-5 text-xs lg:text-sm w-11/12 m-auto md:w-full">
            Description
          </p>
        </div>
      </div>
